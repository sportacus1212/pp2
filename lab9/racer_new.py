...
class Enemy(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\nurzh\Desktop\pp2\lab8\Enemy.png")  # загружаем картинку
...
class Player(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\nurzh\Desktop\pp2\lab8\Player.png")  # загружаем картинку
        self.rect = self.image.get_rect()
...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pg.image.load(r"C:\Users\nurzh\Desktop\pp2\lab8\images\coin.png")  # загружаем картинку
        self.rect = self.image.get_rect()
